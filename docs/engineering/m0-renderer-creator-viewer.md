...
| `corepack pnpm run check:dependencies` | M0-015 报告绑定主断言 `2076/2076`；M0-016 冻结测试入口与 esbuild build policy 后当前为 `2087/2087`，self-test `193/193`、domain contract `60/60`、循环 `0` |
